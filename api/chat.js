// api/chat.js — Google Gemini(무료 등급) 프록시 (Vercel 서버리스 함수)
...
const MODEL = 'gemini-2.5-flash'; // 무료 등급. 지시 이행·품질 우선. 분당 한도가 빡빡하면 'gemini-2.5-flash-lite'로 교체.
  ...
  try {
    ...
    const body = {
      ...
      generationConfig: {
        ...
        temperature: 0.7,
        // 사고 토큰이 출력 예산을 잡아먹지 않도록 thinking 비활성화.
        // 만약 이 줄에서 오류가 나면 thinkingConfig 줄만 지우세요.
